...
-(void)initData
{
    ...
    self.emotionsArray1=[[NSArray alloc] initWithObjects:@"[嘻嘻]",@"[鄙视]",@"[亲亲]",@"[太开心]",@"[懒得理你]",@"[右哼哼]",@"[左哼哼]",@"[嘘]",@"[衰]",@"[委屈]",@"[吐]",@"[打哈欠]",@"[抱抱]",@"[疑问]",@"[拜拜]",@"[思考]",@"[睡觉]",@"[钱]",@"[哼]",@"[鼓掌]",@"[抓狂]",@"[怒骂]",@"[熊猫]",@"[奥特曼]",@"[猪头]",@"[蜡烛]",@"[蛋糕]",@"[din推撞]", nil];
}
...
{
    self.emotionPageControl=[[UIPageControl alloc] initWithFrame:CGRectMake(135, CGRectGetHeight(self.frame) - 30, 40, 50)];
